<template>
	<transition enter-active-class="animated slideInUp">
		<main>
			...
			<component :is="page" :myid="songid"></component>
			<div class="play_btm">
				<ul class="select">
...
<script>
	...
	export default{
		...
		watch:{
			songid(){
				this.time=this.currentPlay.time;
				this.record=this.currentPlay.time;
			}
		},
		filters:{
			toTime(n){
		...
		mounted(){
			this.time=this.currentPlay.time;
			this.record=this.currentPlay.time;
			this.songid=this.currentPlay.id;
